 ...
 *
 */
static inline uint8_t xor_checksum_calculate(const void* data, unsigned size) {
	uint8_t checksum = 0;
 ...
 *
 */
static inline bool xor_checksum_check(const void* data, unsigned size, uint8_t chksum) {

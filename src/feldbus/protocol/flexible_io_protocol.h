 ...
 * @{
 */
#define TURAG_FELDBUS_STELLANTRIEBE_COMMAND_ACCESS_READ_ONLY_ACCESS (0x00)
#define TURAG_FELDBUS_STELLANTRIEBE_COMMAND_ACCESS_WRITE_ONLY_ACCESS (0x01)
#define TURAG_FELDBUS_STELLANTRIEBE_COMMAND_ACCESS_READ_AND_WRITE_ACCESS (0x02)
///@}
 ...
 * @{
 */
#define TURAG_FELDBUS_STELLANTRIEBE_SERVO_MEASURED_POSITION "measuredPosition"
#define TURAG_FELDBUS_STELLANTRIEBE_SERVO_DESIRED_POSITION "desiredPosition"
#define TURAG_FELDBUS_STELLANTRIEBE_SERVO_MAX_POSITION "maxPosition"
#define TURAG_FELDBUS_STELLANTRIEBE_SERVO_MIN_POSITION "minPosition"
